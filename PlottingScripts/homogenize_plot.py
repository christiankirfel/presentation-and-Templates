...
def set_params(fig_width=None, fig_height=None, columns=1, fontsize=11, dpi=300,
            serif='sans-serif', font='Arial', latex=False, latex_extra='',
            ticks='inall', minor=True):
    ...
    latex : True is default, use LaTeX for text
    ...
    latex_preamble += r'\usepackage[utf8]{inputenc}\usepackage[T1]{fontenc}\usepackage{helvet}'
