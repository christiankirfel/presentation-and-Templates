...
%  \begin{itemize}
%    \item (Still) Preliminary selection of variables
...
%\end{frame}
%
%\begin{frame}{A first optimisation hadhad}
%    \begin{table}[]
%    \begin{tabular}{|l|l|}
%    \hline
...
\begin{columns}
  \begin{column}{0.5\textwidth}
    \begin{figure}
      \includegraphics[width=\textwidth]{losses_hadhad.png}
    \end{figure}
  \end{column}
  \begin{column}{0.5\textwidth}
    \begin{figure}
      \includegraphics[width=\textwidth]{acc_hadhad.png}
    \end{figure}
  \end{column}
\end{columns}
\end{frame}
