...
\title[Neural network results in the ditau hadhad channel]{Hadronic Tau MVA}
\subtitle{\today}
...
%\input{optimisation_hadhad.tex}
\input{optimisation_lephad.tex}
\section{Categorical classification}
%\input{categorical_hadhad.tex}
\input{categorical_lephad.tex}
%\input{negWeights_hadhad.tex}
%\section{BDT}
%\input{BDT.tex}
%\section{lephad}
%\input{lephad.tex}
